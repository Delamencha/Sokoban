...
namespace Sokoban
{
    public class ReferenceSolutionPanelView : MonoBehaviour
    {
        [SerializeField] private GameObject container;
        [SerializeField] private GameObject root;
        [SerializeField] private Button returnSolutionButton;
        ...
        public void Initialize(Action onReturnSolution, Action onReturnEditor, Action onRestart)
        {
            BindButton(returnSolutionButton, onReturnSolution);
